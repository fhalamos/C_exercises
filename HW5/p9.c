/*Write a shared memory parallel version of GE solve() using either OpenMP or PThreads.
Include a simple test driver that allows the user to specify the number of threads, initializes a
small test matrix and RHS vector, calls GE solve(), and prints the results. Name this source
file p9.c*/
...
void GE_solve_parallel(double ** m, double* b, int n, int nthreads)
{
	double solution[n];
...
int main(int argc, char const *argv[])
{
	...
	printf("PARALLEL GE:\n\n");
	GE_solve_parallel(matrix,b, n, nthreads);	
